...
// createTestGLAccount creates a test GL account (311 - Bank account)
func createTestGLAccount(ctx context.Context, tx *sqlx.Tx, orgID, userID uuidv7.UUID) (uuidv7.UUID, error) {
