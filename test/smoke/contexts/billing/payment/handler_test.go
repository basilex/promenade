...
type MockPaymentUseCase struct {
	CreatePaymentFunc   func(ctx context.Context, customerID uuidv7.UUID, amount valueobject.Money, method payment.PaymentMethod) (*payment.Payment, error)
	GetPaymentFunc      func(ctx context.Context, paymentID uuidv7.UUID) (*payment.Payment, error)
	...
	ListPaymentsFunc    func(ctx context.Context, page, pageSize int) ([]*payment.Payment, error)
	...
	GetPaymentByNumberFunc     func(ctx context.Context, paymentNo string) (*payment.Payment, error)
	GetPaymentByTransactionIDFunc func(ctx context.Context, transactionID string) (*payment.Payment, error)
	...
	ListPaymentsByCustomerFunc     func(ctx context.Context, customerID uuidv7.UUID, page, pageSize int) ([]*payment.Payment, error)
	ListPaymentsByInvoiceFunc      func(ctx context.Context, invoiceID uuidv7.UUID) ([]*payment.Payment, error)
	ListPaymentsByStatusFunc       func(ctx context.Context, status payment.PaymentStatus, page, pageSize int) ([]*payment.Payment, error)
...
func (m *MockPaymentUseCase) CreatePayment(ctx context.Context, customerID uuidv7.UUID, amount valueobject.Money, method payment.PaymentMethod) (*payment.Payment, error) {
...
func (m *MockPaymentUseCase) GetPayment(ctx context.Context, paymentID uuidv7.UUID) (*payment.Payment, error) {
...
func (m *MockPaymentUseCase) GetPaymentByNumber(ctx context.Context, paymentNo string) (*payment.Payment, error) {
...
func (m *MockPaymentUseCase) GetPaymentByTransactionID(ctx context.Context, transactionID string) (*payment.Payment, error) {
...
func (m *MockPaymentUseCase) ListPayments(ctx context.Context, page, pageSize int) ([]*payment.Payment, error) {
...
func (m *MockPaymentUseCase) ListPaymentsByCustomer(ctx context.Context, customerID uuidv7.UUID, page, pageSize int) ([]*payment.Payment, error) {
...
func (m *MockPaymentUseCase) ListPaymentsByInvoice(ctx context.Context, invoiceID uuidv7.UUID) ([]*payment.Payment, error) {
...
func (m *MockPaymentUseCase) ListPaymentsByStatus(ctx context.Context, status payment.PaymentStatus, page, pageSize int) ([]*payment.Payment, error) {
...
func fakePayment() *payment.Payment {
...
func TestPaymentHandler_ListPayments_Success(t *testing.T) {
	...
	mockUC := &MockPaymentUseCase{
		ListPaymentsFunc: func(ctx context.Context, page, pageSize int) ([]*payment.Payment, error) {
			return []*payment.Payment{fakePayment(), fakePayment()}, nil
		},
	}
