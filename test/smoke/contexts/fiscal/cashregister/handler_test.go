...
type MockCashRegisterUseCase struct {
	CreateCashRegisterFunc    func(ctx context.Context, organizationID uuidv7.UUID, fiscalNumber, model string, createdBy uuidv7.UUID) (*cashregister.CashRegister, error)
	GetCashRegisterFunc       func(ctx context.Context, id uuidv7.UUID) (*cashregister.CashRegister, error)
	GetByFiscalNumberFunc     func(ctx context.Context, fiscalNumber string) (*cashregister.CashRegister, error)
	ListCashRegistersFunc     func(ctx context.Context, organizationID *uuidv7.UUID) ([]*cashregister.CashRegister, error)
	...
	UpdateCashRegisterFunc    func(ctx context.Context, cashRegister *cashregister.CashRegister) error
...
func fakeCashRegister() *cashregister.CashRegister {
	orgID := uuidv7.New()
	userID := uuidv7.New()
	cr, _ := cashregister.NewCashRegister(orgID, "FN-123456", "Model X", userID)
	return cr
}
...
func TestCashRegisterHandler_List_Success(t *testing.T) {
	...
	mockUC := &MockCashRegisterUseCase{
		ListCashRegistersFunc: func(ctx context.Context, organizationID *uuidv7.UUID) ([]*cashregister.CashRegister, error) {
			return []*cashregister.CashRegister{fakeCashRegister(), fakeCashRegister()}, nil
		},
	}
