...
func CountriesData() []*country.Country {
	...
	return []*country.Country{
		...
		// Asia
		newCountry("JP", "JPN", "392", "Japan", "日本", "+81", "Tokyo", "Asia", "Eastern Asia", "🇯🇵",
		...
		newCountry("CN", "CHN", "156", "China", "中国", "+86", "Beijing", "Asia", "Eastern Asia", "🇨🇳",
		...
		newCountry("KR", "KOR", "410", "South Korea", "대한민국", "+82", "Seoul", "Asia", "Eastern Asia", "🇰🇷",
