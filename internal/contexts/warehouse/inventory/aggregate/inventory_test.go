...
func TestNewInventory_MissingProductID(t *testing.T) {
	...
	assert.Error(t, err)
	assert.Nil(t, inv)
	assert.ErrorIs(t, err, inventoryerrors.ErrInventoryProductIDRequired)
}
...
func TestNewInventory_MissingSKU(t *testing.T) {
	...
	assert.Error(t, err)
	assert.Nil(t, inv)
	assert.ErrorIs(t, err, inventoryerrors.ErrInventorySKURequired)
}
...
func TestNewInventory_MissingProductName(t *testing.T) {
	...
	assert.Error(t, err)
	assert.Nil(t, inv)
	assert.ErrorIs(t, err, inventoryerrors.ErrInventoryProductNameRequired)
}
...
func TestNewInventory_MissingWarehouseID(t *testing.T) {
	...
	assert.Error(t, err)
	assert.Nil(t, inv)
	assert.ErrorIs(t, err, inventoryerrors.ErrInventoryWarehouseRequired)
}
...
func TestReceiveStock_ZeroQuantity(t *testing.T) {
	...
	assert.Error(t, err)
	assert.ErrorIs(t, err, inventoryerrors.ErrInventoryQuantityInvalid)
}
...
func TestReceiveStock_InactiveInventory(t *testing.T) {
	...
	assert.Error(t, err)
	assert.ErrorIs(t, err, inventoryerrors.ErrInventoryInactive)
}
...
func TestReserveStock_InsufficientStock(t *testing.T) {
	...
	assert.Error(t, err)
	assert.ErrorIs(t, err, inventoryerrors.ErrInventoryInsufficientStock)
	assert.Equal(t, 0, inv.QuantityReserved)
}
...
func TestReleaseReservation_InsufficientReserved(t *testing.T) {
	...
	assert.Error(t, err)
	assert.ErrorIs(t, err, inventoryerrors.ErrInventoryInsufficientReserved)
	assert.Equal(t, 30, inv.QuantityReserved)
}
...
func TestAdjustStock_ResultsInNegative(t *testing.T) {
	...
	assert.Error(t, err)
	assert.ErrorIs(t, err, inventoryerrors.ErrInventoryNegativeStock)
...
func TestAdjustStock_MissingReason(t *testing.T) {
	...
	assert.Error(t, err)
	assert.ErrorIs(t, err, inventoryerrors.ErrInventoryAdjustmentReasonRequired)
}
...
func TestSetLocation_MissingLocationCode(t *testing.T) {
	...
	assert.Error(t, err)
	assert.ErrorIs(t, err, inventoryerrors.ErrInventoryLocationRequired)
}
...
func TestSetReorderPoint_NegativePoint(t *testing.T) {
	...
	assert.Error(t, err)
	assert.ErrorIs(t, err, inventoryerrors.ErrInventoryReorderPointNegative)
}
...
func TestSetReorderPoint_ZeroQuantity(t *testing.T) {
	...
	assert.Error(t, err)
	assert.ErrorIs(t, err, inventoryerrors.ErrInventoryReorderQuantityInvalid)
}
...
func TestMarkAsDamaged_InsufficientStock(t *testing.T) {
	...
	assert.Error(t, err)
	assert.ErrorIs(t, err, inventoryerrors.ErrInventoryInsufficientAvailable)
}
...
func TestActivate_AlreadyActive(t *testing.T) {
	...
	assert.Error(t, err)
	assert.ErrorIs(t, err, inventoryerrors.ErrInventoryAlreadyActive)
}
...
func TestDeactivate_WithReservedStock(t *testing.T) {
	...
	assert.Error(t, err)
	assert.ErrorIs(t, err, inventoryerrors.ErrInventoryCannotDeactivateWithReservedStock)
	assert.True(t, inv.IsActive)
}
...
func TestValidate_NegativeQuantityOnHand(t *testing.T) {
	...
	assert.Error(t, err)
	assert.ErrorIs(t, err, inventoryerrors.ErrInventoryQuantityOnHandNegative)
}
...
func TestValidate_NegativeReserved(t *testing.T) {
	...
	assert.Error(t, err)
	assert.ErrorIs(t, err, inventoryerrors.ErrInventoryQuantityReservedNegative)
}
...
func TestValidate_NotesTooLong(t *testing.T) {
	...
	assert.Error(t, err)
	assert.ErrorIs(t, err, inventoryerrors.ErrInventoryNotesTooLong)
}
