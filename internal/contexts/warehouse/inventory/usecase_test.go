...
type MockRepository struct {
	CreateFunc          func(ctx context.Context, inv *Inventory) error
	GetByIDFunc         func(ctx context.Context, id uuidv7.UUID) (*Inventory, error)
	GetBySKUFunc        func(ctx context.Context, sku string) (*Inventory, error)
	GetByProductIDFunc  func(ctx context.Context, productID uuidv7.UUID) ([]*Inventory, error)
	GetByWarehouseFunc  func(ctx context.Context, warehouseID string) ([]*Inventory, error)
	GetLowStockFunc     func(ctx context.Context) ([]*Inventory, error)
	ListInventoryFunc  func(ctx context.Context, limit, offset int) ([]*Inventory, int64, error)
	UpdateFunc         func(ctx context.Context, inventory *Inventory) error
	DeleteFunc         func(ctx context.Context, id uuidv7.UUID) error
	GetByLocationFunc  func(ctx context.Context, warehouseID, locationCode string) ([]*Inventory, error)
	GetByStatusFunc    func(ctx context.Context, status InventoryStatus) ([]*Inventory, error)
	BulkUpdateFunc      func(ctx context.Context, items []*Inventory) error
}

func (m *MockRepository) Create(ctx context.Context, inv *Inventory) error {
	if m.CreateFunc != nil {
...
func (m *MockRepository) GetByID(ctx context.Context, id uuidv7.UUID) (*Inventory, error) {
...
func (m *MockRepository) GetBySKU(ctx context.Context, sku string) (*Inventory, error) {
...
func (m *MockRepository) GetByProductID(ctx context.Context, productID uuidv7.UUID) ([]*Inventory, error) {
...
func (m *MockRepository) GetByWarehouse(ctx context.Context, warehouseID string) ([]*Inventory, error) {
...
func (m *MockRepository) GetLowStock(ctx context.Context) ([]*Inventory, error) {
...
func (m *MockRepository) List(ctx context.Context, limit, offset int) ([]*Inventory, int64, error) {
...
func (m *MockRepository) Update(ctx context.Context, inv *Inventory) error {
	if m.UpdateFunc != nil {
...
func (m *MockRepository) BulkUpdate(ctx context.Context, items []*Inventory) error {
...
func (m *MockRepository) GetByLocation(ctx context.Context, warehouseID, locationCode string) ([]*Inventory, error) {
...
func (m *MockRepository) GetByStatus(ctx context.Context, status InventoryStatus) ([]*Inventory, error) {
...
func TestCreateInventory_DuplicateSKU(t *testing.T) {
	productID := uuidv7.New()
	existingInv, _ := NewInventory(productID, "TEST-SKU-001", "Existing", "WH-MAIN", testUserID)
...
func TestGetInventory_Success(t *testing.T) {
	id := uuidv7.New()
	productID := uuidv7.New()
	expected, _ := NewInventory(productID, "TEST-SKU", "Product", "WH-MAIN", testUserID)

	repo := &MockRepository{
		GetByIDFunc: func(ctx context.Context, invID uuidv7.UUID) (*Inventory, error) {
...
func TestGetByProductID(t *testing.T) {
	productID := uuidv7.New()
	inv1, _ := NewInventory(productID, "SKU-1", "Product", "WH-1", testUserID)
	inv2, _ := NewInventory(productID, "SKU-2", "Product", "WH-2", testUserID)

	repo := &MockRepository{
		GetByProductIDFunc: func(ctx context.Context, pid uuidv7.UUID) ([]*Inventory, error) {
			assert.Equal(t, productID, pid)
			return []*Inventory{inv1, inv2}, nil
		},
	}
...
func TestGetByWarehouse(t *testing.T) {
	productID := uuidv7.New()
	inv1, _ := NewInventory(productID, "SKU-1", "Product 1", "WH-MAIN", testUserID)
	inv2, _ := NewInventory(productID, "SKU-2", "Product 2", "WH-MAIN", testUserID)
...
func TestListInventory(t *testing.T) {
	...
	repo := &MockRepository{
		ListInventoryFunc: func(ctx context.Context, limit, offset int) ([]*Inventory, int64, error) {
			...
			return []*Inventory{inv1, inv2}, 2, nil
		},
	}
...
func TestUpdateInventory_Success(t *testing.T) {
	productID := uuidv7.New()
	inv, _ := NewInventory(productID, "TEST-SKU", "Product", "WH-MAIN", testUserID)

	repo := &MockRepository{
		GetByIDFunc: func(ctx context.Context, id uuidv7.UUID) (*Inventory, error) {
			return inv, nil
		},
		UpdateFunc: func(ctx context.Context, updated *Inventory) error {
