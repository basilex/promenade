...
func ToLocationResponse(loc *aggregate.Location) LocationResponse {
...
func ToLocationListResponse(locations []*aggregate.Location, total, page, pageSize int) LocationListResponse {
...
func ToCapacityResponse(loc *aggregate.Location) CapacityResponse {
	...
	return CapacityResponse{
		...
		IsLimited:         loc.IsLimited,
		IsFull:            loc.Status == aggregate.LocationStatusFull,
	}
}

// ParseLocationType converts string to LocationType
func ParseLocationType(typeStr string) aggregate.LocationType {
	return aggregate.LocationType(typeStr)
}

// ParseLocationStatus converts string to LocationStatus
func ParseLocationStatus(statusStr string) aggregate.LocationStatus {
	return aggregate.LocationStatus(statusStr)
}
