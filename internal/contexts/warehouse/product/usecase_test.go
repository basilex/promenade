...
type MockRepository struct {
	...
	GetByIDFunc             func(ctx context.Context, id uuidv7.UUID) (*Product, error)
	GetBySKUFunc            func(ctx context.Context, sku string) (*Product, error)
	UpdateFunc              func(ctx context.Context, p *Product) error
	DeleteFunc              func(ctx context.Context, id uuidv7.UUID) error
	ListFunc                func(ctx context.Context, page, pageSize int) ([]*Product, error)
	ListByCategoryFunc      func(ctx context.Context, category string, page, pageSize int) ([]*Product, error)
	ListByBrandFunc         func(ctx context.Context, brand string, page, pageSize int) ([]*Product, error)
	ListByStatusFunc        func(ctx context.Context, status ProductStatus, page, pageSize int) ([]*Product, error)
	SearchFunc              func(ctx context.Context, query string, page, pageSize int) ([]*Product, error)
	CountFunc               func(ctx context.Context) (int, error)
	ExistsBySKUFunc         func(ctx context.Context, sku string) (bool, error)
	GetByIDsFunc            func(ctx context.Context, ids []uuidv7.UUID) ([]*Product, error)
	ListLowStockFunc        func(ctx context.Context, page, pageSize int) ([]*Product, error)
	BulkUpdateStatusFunc    func(ctx context.Context, ids []uuidv7.UUID, status ProductStatus) error
}
...
func (m *MockRepository) GetByID(ctx context.Context, id uuidv7.UUID) (*Product, error) {
...
func (m *MockRepository) List(ctx context.Context, page, pageSize int) ([]*Product, error) {
	if m.ListFunc != nil {
...
func (m *MockRepository) ListByCategory(ctx context.Context, category string, page, pageSize int) ([]*Product, error) {
...
func (m *MockRepository) ListByBrand(ctx context.Context, brand string, page, pageSize int) ([]*Product, error) {
...
func (m *MockRepository) ListByStatus(ctx context.Context, status ProductStatus, page, pageSize int) ([]*Product, error) {
...
func (m *MockRepository) Search(ctx context.Context, query string, page, pageSize int) ([]*Product, error) {
	if m.SearchFunc != nil {
...
func (m *MockRepository) GetByIDs(ctx context.Context, ids []uuidv7.UUID) ([]*Product, error) {
...
func (m *MockRepository) ListLowStock(ctx context.Context, page, pageSize int) ([]*Product, error) {
...
func (m *MockRepository) BulkUpdateStatus(ctx context.Context, ids []uuidv7.UUID, status ProductStatus) error {
...
func createTestProduct(t *testing.T) *Product {
	t.Helper()
	p, err := NewProduct("TEST-SKU-001", "Test Product")
	require.NoError(t, err)
	return p
}

func createTestProductWithDetails(t *testing.T, sku, name, category, brand string) *Product {
	t.Helper()
	p, err := NewProduct(sku, name)
	require.NoError(t, err)
	p.Category = category
	p.Brand = brand
	return p
...
func TestUseCase_CreateProduct_Success(t *testing.T) {
	...
	product, err := uc.CreateProduct(context.Background(), "TEST-SKU-001", "Test Product")
...
func TestUseCase_CreateProduct_DuplicateSKU(t *testing.T) {
	...
	assert.ErrorIs(t, err, ErrProductSKUDuplicate)
}
...
func TestUseCase_ListProductsByCategory_Success(t *testing.T) {
	expectedProducts := []*Product{
		createTestProductWithDetails(t, "SKU-1", "Product 1", "Electronics", "Brand A"),
		createTestProductWithDetails(t, "SKU-2", "Product 2", "Electronics", "Brand B"),
	}
...
func TestUseCase_ListProductsByBrand_Success(t *testing.T) {
	expectedProducts := []*Product{
		createTestProductWithDetails(t, "SKU-1", "Product 1", "Electronics", "BrandA"),
	}
...
func TestUseCase_ListProductsByStatus_Success(t *testing.T) {
	...
	products, err := uc.ListProductsByStatus(context.Background(), ProductStatusActive, 1, 10)

	assert.NoError(t, err)
	assert.Len(t, products, 1)
	assert.Equal(t, ProductStatusActive, products[0].Status)
}
...
func TestUseCase_DeactivateProduct_Success(t *testing.T) {
	product := createTestProduct(t)
	product.Status = ProductStatusActive // Start with Active status
