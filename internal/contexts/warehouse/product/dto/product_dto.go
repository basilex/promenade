...
func ToProductResponse(p *aggregate.Product) ProductResponse {
...
func ToProductListResponse(products []*aggregate.Product, total, page, pageSize int) ProductListResponse {
