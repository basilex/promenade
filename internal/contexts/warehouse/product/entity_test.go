...
func TestProduct_SetPhysicalProperties(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			wantErr: ErrProductInvalidWeight,
		},
		{
			...
			wantErr: ErrProductInvalidDimension,
		},
		{
			name:   "negative width",
			weight: 1.5,
...
func TestProduct_SetReorderPoint(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			point:    50,
			quantity: 50,
			wantErr:  ErrProductInvalidReorder,
		},
		{
...
func TestProduct_Activate(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			wantErr:     ErrProductAlreadyActive,
		},
	}
...
func TestProduct_Deactivate(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			isActive: false,
			wantErr:  ErrProductAlreadyInactive,
		},
	}
...
func TestProduct_Discontinue(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			setupStatus: ProductStatusDiscontinued,
			wantErr:     ErrProductDiscontinued,
		},
	}
