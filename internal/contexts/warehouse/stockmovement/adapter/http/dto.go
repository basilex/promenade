...
func ToMovementResponse(sm *stockmovement.StockMovement) *MovementResponse {
...
func ToMovementResponseList(movements []*stockmovement.StockMovement) []*MovementResponse {
