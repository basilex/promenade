...
// mockRepository implements IStockMovementRepository interface with function fields for testing
type mockRepository struct {
	CreateFunc                func(ctx context.Context, movement *aggregate.StockMovement) error
	GetByIDFunc               func(ctx context.Context, id uuidv7.UUID) (*aggregate.StockMovement, error)
	GetByInventoryIDFunc      func(ctx context.Context, inventoryID uuidv7.UUID, page, pageSize int) ([]*aggregate.StockMovement, int, error)
	GetByReferenceFunc        func(ctx context.Context, referenceType string, referenceID uuidv7.UUID) ([]*aggregate.StockMovement, error)
	GetByTypeFunc             func(ctx context.Context, movementType aggregate.MovementType, startDate, endDate time.Time, page, pageSize int) ([]*aggregate.StockMovement, int, error)
	GetByDateRangeFunc        func(ctx context.Context, startDate, endDate time.Time, page, pageSize int) ([]*aggregate.StockMovement, int, error)
	GetSummaryByInventoryFunc func(ctx context.Context, inventoryID uuidv7.UUID, startDate, endDate time.Time) (int, int, error)
	GetRecentMovementsFunc    func(ctx context.Context, limit int) ([]*aggregate.StockMovement, error)
	CountByTypeFunc           func(ctx context.Context, startDate, endDate time.Time) (map[aggregate.MovementType]int, error)
}

func (m *mockRepository) Create(ctx context.Context, movement *aggregate.StockMovement) error {
	if m.CreateFunc != nil {
...
func (m *mockRepository) GetByID(ctx context.Context, id uuidv7.UUID) (*aggregate.StockMovement, error) {
	if m.GetByIDFunc != nil {
		return m.GetByIDFunc(ctx, id)
	}
	return nil, stockmovementerrors.ErrStockMovementNotFound
}

func (m *mockRepository) GetByInventoryID(ctx context.Context, inventoryID uuidv7.UUID, page, pageSize int) ([]*aggregate.StockMovement, int, error) {
...
func (m *mockRepository) GetByReference(ctx context.Context, referenceType string, referenceID uuidv7.UUID) ([]*aggregate.StockMovement, error) {
...
func (m *mockRepository) GetByType(ctx context.Context, movementType aggregate.MovementType, startDate, endDate time.Time, page, pageSize int) ([]*aggregate.StockMovement, int, error) {
...
func (m *mockRepository) GetByDateRange(ctx context.Context, startDate, endDate time.Time, page, pageSize int) ([]*aggregate.StockMovement, int, error) {
...
func (m *mockRepository) GetRecentMovements(ctx context.Context, limit int) ([]*aggregate.StockMovement, error) {
...
func (m *mockRepository) CountByType(ctx context.Context, startDate, endDate time.Time) (map[aggregate.MovementType]int, error) {
...
func TestNewUseCase(t *testing.T) {
	repo := &mockRepository{}
	uc := NewStockMovementUseCase(repo)
	assert.NotNil(t, uc)
}
...
func TestUseCase_RecordMovement(t *testing.T) {
	...
	movement, err := uc.RecordMovement(ctx, inventoryID, aggregate.MovementTypeReceipt, 10, 100, createdBy)
	require.NoError(t, err)
	assert.NotNil(t, movement)
	assert.Equal(t, inventoryID, movement.InventoryID)
	assert.Equal(t, aggregate.MovementTypeReceipt, movement.Type)
...
func TestUseCase_RecordReceipt(t *testing.T) {
	...
	t.Run("zero quantity", func(t *testing.T) {
		...
		assert.Error(t, err)
		assert.ErrorIs(t, err, stockmovementerrors.ErrStockMovementCreateFailed)
	})
	...
	t.Run("repository error", func(t *testing.T) {
		...
		assert.Error(t, err)
		assert.ErrorIs(t, err, stockmovementerrors.ErrStockMovementSaveFailed)
	})
}
...
func TestUseCase_RecordReservation(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		...
		assert.Equal(t, aggregate.MovementTypeReservation, movement.Type)
...
func TestUseCase_RecordCommit(t *testing.T) {
	...
	assert.Equal(t, aggregate.MovementTypeCommit, movement.Type)
	assert.Equal(t, "order", movement.ReferenceType)
}
...
func TestUseCase_RecordAdjustment(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		...
		require.NoError(t, err)
		assert.NotNil(t, movement)
		assert.Equal(t, aggregate.MovementTypeAdjustment, movement.Type)
...
func TestUseCase_RecordTransfer(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		...
		require.NoError(t, err)
		assert.NotNil(t, movement)
		assert.Equal(t, aggregate.MovementTypeTransfer, movement.Type)
...
func TestUseCase_GetMovement(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		...
		repo := &mockRepository{
			GetByIDFunc: func(ctx context.Context, id uuidv7.UUID) (*aggregate.StockMovement, error) {
				movement, _ := aggregate.NewStockMovement(uuidv7.New(), aggregate.MovementTypeReceipt, 10, 100, uuidv7.New())
				return movement, nil
			},
		}
		uc := NewStockMovementUseCase(repo)
	...
	t.Run("not found", func(t *testing.T) {
		...
		assert.Error(t, err)
		assert.ErrorIs(t, err, stockmovementerrors.ErrStockMovementNotFound)
	})
}
...
func TestUseCase_GetMovementsByInventory(t *testing.T) {
	inventoryID := uuidv7.New()
	repo := &mockRepository{
		GetByInventoryIDFunc: func(ctx context.Context, invID uuidv7.UUID, page, pageSize int) ([]*aggregate.StockMovement, int, error) {
			m1, _ := aggregate.NewStockMovement(invID, aggregate.MovementTypeReceipt, 10, 100, uuidv7.New())
			m2, _ := aggregate.NewStockMovement(invID, aggregate.MovementTypeReservation, -5, 110, uuidv7.New())
			movements := []*aggregate.StockMovement{m1, m2}
...
func TestUseCase_GetMovementsByType(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		repo := &mockRepository{
			GetByTypeFunc: func(ctx context.Context, movementType aggregate.MovementType, startDate, endDate time.Time, page, pageSize int) ([]*aggregate.StockMovement, int, error) {
				movement, _ := aggregate.NewStockMovement(uuidv7.New(), movementType, 10, 100, uuidv7.New())
				movements := []*aggregate.StockMovement{movement}
		...
		movements, total, err := uc.GetMovementsByType(ctx, aggregate.MovementTypeReceipt, startDate, endDate, 1, 10)
		require.NoError(t, err)
	...
	t.Run("invalid date range", func(t *testing.T) {
		...
		_, _, err := uc.GetMovementsByType(ctx, aggregate.MovementTypeReceipt, startDate, endDate, 1, 10)
		assert.Error(t, err)
		assert.ErrorIs(t, err, stockmovementerrors.ErrInvalidDateRange)
	})
}
