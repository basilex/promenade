...
func ToSubscriptionResponse(s *aggregate.Subscription) SubscriptionResponse {
...
func ParseBillingPeriod(s string) aggregate.BillingPeriod {
	switch s {
	case "monthly":
		return aggregate.BillingPeriodMonthly
	case "quarterly":
		return aggregate.BillingPeriodQuarterly
	case "yearly":
		return aggregate.BillingPeriodYearly
	default:
		return aggregate.BillingPeriodMonthly
	}
}
