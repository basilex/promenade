...
import (
	...
	"github.com/basilex/promenade/internal/contexts/billing/payment/dto"
...
type PaymentHandler struct {
	u usecase.IPaymentUseCase
}

// NewPaymentHandler creates a new payment handler
func NewPaymentHandler(u usecase.IPaymentUseCase) *PaymentHandler {
...
// @Accept json
// @Produce json
// @Param payment body dto.CreatePaymentRequest true "Payment data"
...
func (h *PaymentHandler) Create(c *gin.Context) {
	...
	p, err := h.u.CreatePayment(c.Request.Context(), customerID, amount, aggregate.PaymentMethod(req.Method))
	if err != nil {
	...
	if req.InvoiceID != nil {
		invoiceID, err := uuidv7.Parse(*req.InvoiceID)
		if err != nil {
			response.ErrorResponse(c, http.StatusBadRequest, "INVALID_INVOICE_ID", "Invalid invoice ID format")
			return
		}
		if err := h.u.LinkToInvoice(c.Request.Context(), p.GetID(), invoiceID); err != nil {
	...
	if req.Notes != "" {
		if err := h.u.AddNote(c.Request.Context(), p.GetID(), req.Notes); err != nil {
	...
	p, err = h.u.GetPayment(c.Request.Context(), p.GetID())
	if err != nil {
...
func (h *PaymentHandler) GetByID(c *gin.Context) {
	...
	p, err := h.u.GetPayment(c.Request.Context(), id)
	...
	response.Success(c, dto.ToPaymentResponse(p))
}
...
func (h *PaymentHandler) GetByNumber(c *gin.Context) {
	...
	p, err := h.u.GetPaymentByNumber(c.Request.Context(), paymentNo)
	if errors.Is(err, paymenterrors.ErrPaymentNotFound) {
		response.ErrorResponse(c, http.StatusNotFound, "NOT_FOUND", "Payment not found")
		return
	}
...
func (h *PaymentHandler) GetByTransactionID(c *gin.Context) {
	...
	p, err := h.u.GetPaymentByTransactionID(c.Request.Context(), transactionID)
	if errors.Is(err, paymenterrors.ErrPaymentNotFound) {
		response.ErrorResponse(c, http.StatusNotFound, "NOT_FOUND", "Payment not found")
		return
	}
...
func (h *PaymentHandler) Delete(c *gin.Context) {
	...
	if err := h.u.DeletePayment(c.Request.Context(), id); err != nil {
		if errors.Is(err, paymenterrors.ErrPaymentNotFound) {
			response.ErrorResponse(c, http.StatusNotFound, "NOT_FOUND", "Payment not found")
			return
		}
...
func (h *PaymentHandler) List(c *gin.Context) {
	...
	payments, err := h.u.ListPayments(c.Request.Context(), page, pageSize)
	if err != nil {
		response.ErrorResponse(c, http.StatusInternalServerError, "LIST_FAILED", "Failed to list payments")
		return
	}

	response.Success(c, dto.ToPaymentResponseList(payments))
}
...
func (h *PaymentHandler) ListByCustomer(c *gin.Context) {
	customerID, err := uuidv7.Parse(c.Param("customerId"))
	if err != nil {
		response.ErrorResponse(c, http.StatusBadRequest, "INVALID_CUSTOMER_ID", "Invalid customer ID format")
		return
	}
	...
	payments, err := h.u.ListPaymentsByCustomer(c.Request.Context(), customerID, page, pageSize)
	if err != nil {
		response.ErrorResponse(c, http.StatusInternalServerError, "LIST_FAILED", "Failed to list payments")
		return
	}
...
func (h *PaymentHandler) ListByInvoice(c *gin.Context) {
	invoiceID, err := uuidv7.Parse(c.Param("invoiceId"))
	if err != nil {
		response.ErrorResponse(c, http.StatusBadRequest, "INVALID_INVOICE_ID", "Invalid invoice ID format")
		return
	}

	payments, err := h.u.ListPaymentsByInvoice(c.Request.Context(), invoiceID)
	if err != nil {
		response.ErrorResponse(c, http.StatusInternalServerError, "LIST_FAILED", "Failed to list payments")
		return
	}
...
func (h *PaymentHandler) ListByStatus(c *gin.Context) {
	status := aggregate.PaymentStatus(c.Param("status"))

	page, _ := strconv.Atoi(c.DefaultQuery("page", "1"))
	pageSize, _ := strconv.Atoi(c.DefaultQuery("page_size", "20"))

	payments, err := h.u.ListPaymentsByStatus(c.Request.Context(), status, page, pageSize)
	if err != nil {
		response.ErrorResponse(c, http.StatusInternalServerError, "LIST_FAILED", "Failed to list payments")
		return
	}
...
// @Produce json
// @Param id path string true "Payment ID"
// @Param request body dto.LinkInvoiceRequest true "Invoice ID"
// @Success 200 {object} dto.PaymentResponse
// @Failure 400 {object} response.Response
// @Failure 404 {object} response.Response
// @Failure 500 {object} response.Response
...
func (h *PaymentHandler) LinkToInvoice(c *gin.Context) {
	paymentID, err := uuidv7.Parse(c.Param("id"))
	if err != nil {
		response.ErrorResponse(c, http.StatusBadRequest, "INVALID_ID", "Invalid payment ID format")
		return
	}

	var req dto.LinkInvoiceRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		response.ErrorResponse(c, http.StatusBadRequest, "VALIDATION_ERROR", err.Error())
		return
	}
	...
	if err := h.u.LinkToInvoice(c.Request.Context(), paymentID, invoiceID); err != nil {
		if errors.Is(err, paymenterrors.ErrPaymentNotFound) {
			response.ErrorResponse(c, http.StatusNotFound, "NOT_FOUND", "Payment not found")
			return
		}
	...
	// Reload payment to get updated state
	p, err := h.u.GetPayment(c.Request.Context(), paymentID)
	if err != nil {
		response.ErrorResponse(c, http.StatusInternalServerError, "RELOAD_FAILED", "Failed to retrieve payment")
		return
	}
...
func (h *PaymentHandler) ProcessPayment(c *gin.Context) {
	...
	if err := h.u.ProcessPayment(c.Request.Context(), id, req.TransactionID); err != nil {
		if errors.Is(err, paymenterrors.ErrPaymentNotFound) {
			response.ErrorResponse(c, http.StatusNotFound, "NOT_FOUND", "Payment not found")
			return
		}
...
// @Produce json
// @Param id path string true "Payment ID"
// @Param request body dto.CompletePaymentRequest true "Transaction ID"
// @Success 200 {object} dto.PaymentResponse
// @Failure 400 {object} response.Response
// @Failure 404 {object} response.Response
// @Failure 500 {object} response.Response
...
func (h *PaymentHandler) CompletePayment(c *gin.Context) {
	...
	if err := h.u.CompletePayment(c.Request.Context(), id, req.TransactionID); err != nil {
		if errors.Is(err, paymenterrors.ErrPaymentNotFound) {
			response.ErrorResponse(c, http.StatusNotFound, "NOT_FOUND", "Payment not found")
			return
		}
...
// @Produce json
// @Param id path string true "Payment ID"
// @Param request body dto.FailPaymentRequest true "Failure reason"
// @Success 200 {object} dto.PaymentResponse
// @Failure 400 {object} response.Response
// @Failure 404 {object} response.Response
// @Failure 500 {object} response.Response
...
func (h *PaymentHandler) FailPayment(c *gin.Context) {
	...
	var req dto.FailPaymentRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		response.ErrorResponse(c, http.StatusBadRequest, "VALIDATION_ERROR", err.Error())
		return
	}

	if err := h.u.FailPayment(c.Request.Context(), id, req.Reason); err != nil {
		if errors.Is(err, paymenterrors.ErrPaymentNotFound) {
			response.ErrorResponse(c, http.StatusNotFound, "NOT_FOUND", "Payment not found")
			return
		}
...
// @Produce json
// @Param id path string true "Payment ID"
// @Param request body dto.RefundPaymentRequest true "Refund data"
// @Success 200 {object} dto.PaymentResponse
// @Failure 400 {object} response.Response
// @Failure 404 {object} response.Response
// @Failure 500 {object} response.Response
...
func (h *PaymentHandler) RefundPayment(c *gin.Context) {
	...
	if err := h.u.RefundPayment(c.Request.Context(), id, refundAmount); err != nil {
		if errors.Is(err, paymenterrors.ErrPaymentNotFound) {
			response.ErrorResponse(c, http.StatusNotFound, "NOT_FOUND", "Payment not found")
			return
		}
		if errors.Is(err, paymenterrors.ErrRefundAmountExceedsPayment) {
...
func (h *PaymentHandler) CancelPayment(c *gin.Context) {
	...
	if err := h.u.CancelPayment(c.Request.Context(), id, ""); err != nil {
		if errors.Is(err, paymenterrors.ErrPaymentNotFound) {
			response.ErrorResponse(c, http.StatusNotFound, "NOT_FOUND", "Payment not found")
			return
		}
...
// @Produce json
// @Param id path string true "Payment ID"
// @Param request body dto.SetCardDetailsRequest true "Card details"
// @Success 200 {object} dto.PaymentResponse
// @Failure 400 {object} response.Response
// @Failure 404 {object} response.Response
// @Failure 500 {object} response.Response
...
func (h *PaymentHandler) SetCardDetails(c *gin.Context) {
	...
	var req dto.SetCardDetailsRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		response.ErrorResponse(c, http.StatusBadRequest, "VALIDATION_ERROR", err.Error())
		return
	}

	if err := h.u.SetCardDetails(c.Request.Context(), id, req.Last4, req.Brand); err != nil {
		if errors.Is(err, paymenterrors.ErrPaymentNotFound) {
			response.ErrorResponse(c, http.StatusNotFound, "NOT_FOUND", "Payment not found")
			return
		}
...
// @Produce json
// @Param id path string true "Payment ID"
// @Param request body dto.SetProviderRequest true "Provider"
// @Success 200 {object} dto.PaymentResponse
// @Failure 400 {object} response.Response
// @Failure 404 {object} response.Response
// @Failure 500 {object} response.Response
...
func (h *PaymentHandler) SetProvider(c *gin.Context) {
	...
	var req dto.SetProviderRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		response.ErrorResponse(c, http.StatusBadRequest, "VALIDATION_ERROR", err.Error())
		return
	}

	if err := h.u.SetProvider(c.Request.Context(), id, req.Provider); err != nil {
		if errors.Is(err, paymenterrors.ErrPaymentNotFound) {
			response.ErrorResponse(c, http.StatusNotFound, "NOT_FOUND", "Payment not found")
			return
		}
...
// @Produce json
// @Param id path string true "Payment ID"
// @Param request body dto.AddNoteRequest true "Note"
// @Success 200 {object} dto.PaymentResponse
// @Failure 400 {object} response.Response
// @Failure 404 {object} response.Response
// @Failure 500 {object} response.Response
...
func (h *PaymentHandler) AddNote(c *gin.Context) {
	...
	if err := h.u.AddNote(c.Request.Context(), id, req.Note); err != nil {
		if errors.Is(err, paymenterrors.ErrPaymentNotFound) {
			response.ErrorResponse(c, http.StatusNotFound, "NOT_FOUND", "Payment not found")
			return
		}
...
func (h *PaymentHandler) GetTotalByCustomer(c *gin.Context) {
	...
	total, err := h.u.GetTotalByCustomer(c.Request.Context(), customerID)
	if err != nil {
...
func (h *PaymentHandler) GetTotalByInvoice(c *gin.Context) {
	...
	total, err := h.u.GetTotalByInvoice(c.Request.Context(), invoiceID)
	if err != nil {
		response.ErrorResponse(c, http.StatusInternalServerError, "GET_TOTAL_FAILED", "Failed to get total amount")
		return
	}
