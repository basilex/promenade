...
type mockRepository struct {
	...
	invoicesByNumber map[string]*Invoice
	nextInvoiceNo    int
}
...
func newMockRepository() *mockRepository {
	return &mockRepository{
		...
		invoicesByNumber: make(map[string]*Invoice),
		nextInvoiceNo:    1,
	}
}

func (m *mockRepository) Create(ctx context.Context, invoice *Invoice) error {
	m.invoices[invoice.ID.String()] = invoice
	m.invoicesByNumber[invoice.InvoiceNo] = invoice
	return nil
}

func (m *mockRepository) GetByID(ctx context.Context, id uuidv7.UUID) (*Invoice, error) {
...
func (m *mockRepository) GetByInvoiceNo(ctx context.Context, invoiceNo string) (*Invoice, error) {
...
func (m *mockRepository) Update(ctx context.Context, invoice *Invoice) error {
...
func (m *mockRepository) ListByCustomer(ctx context.Context, customerID uuidv7.UUID, page, pageSize int) ([]*Invoice, int, error) {
	return nil, 0, nil
}

func (m *mockRepository) ListByOrder(ctx context.Context, orderID uuidv7.UUID) ([]*Invoice, error) {
	return nil, nil
}

func (m *mockRepository) ListByStatus(ctx context.Context, status InvoiceStatus, page, pageSize int) ([]*Invoice, int, error) {
	return nil, 0, nil
}

func (m *mockRepository) ListOverdue(ctx context.Context, page, pageSize int) ([]*Invoice, int, error) {
	return nil, 0, nil
}

func (m *mockRepository) List(ctx context.Context, page, pageSize int) ([]*Invoice, int, error) {
	invoices := make([]*Invoice, 0, len(m.invoices))
...
func (m *mockRepository) CountByStatus(ctx context.Context, status InvoiceStatus) (int, error) {
	return 0, nil
}
...
func (m *mockRepository) CreateLine(ctx context.Context, line *InvoiceLine) error {
	return nil
}
...
func (m *mockRepository) GetLinesByInvoiceID(ctx context.Context, invoiceID uuidv7.UUID) ([]InvoiceLine, error) {
...
func TestUseCase_SendInvoice(t *testing.T) {
	...
	t.Run("send invoice with line items", func(t *testing.T) {
		...
		assert.Equal(t, InvoiceStatusSent, sentInv.Status)
	})
}
...
func TestUseCase_MarkAsPaid(t *testing.T) {
	...
	t.Run("mark sent invoice as paid", func(t *testing.T) {
		...
		assert.Equal(t, InvoiceStatusPaid, paidInv.Status)
...
func TestUseCase_CancelInvoice(t *testing.T) {
	...
	t.Run("cancel draft invoice", func(t *testing.T) {
		...
		assert.Equal(t, InvoiceStatusCancelled, cancelledInv.Status)
	})
	...
	t.Run("cannot cancel paid invoice", func(t *testing.T) {
		...
		assert.Error(t, err)
		assert.ErrorIs(t, err, ErrInvoiceCannotCancelTerminalState)
	})
}
