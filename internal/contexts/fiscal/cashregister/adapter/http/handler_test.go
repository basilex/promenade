...
type mockCashRegisterUseCase struct {
	createFunc     func(ctx context.Context, organizationID uuidv7.UUID, fiscalNumber, model string, createdBy uuidv7.UUID) (*cashregister.CashRegister, error)
	getFunc        func(ctx context.Context, id uuidv7.UUID) (*cashregister.CashRegister, error)
	listFunc       func(ctx context.Context, organizationID *uuidv7.UUID) ([]*cashregister.CashRegister, error)
	activateFunc   func(ctx context.Context, id uuidv7.UUID, licenseKey string, activatedBy uuidv7.UUID) (*cashregister.CashRegister, error)
	deactivateFunc func(ctx context.Context, id uuidv7.UUID, deactivatedBy uuidv7.UUID) (*cashregister.CashRegister, error)
	deleteFunc     func(ctx context.Context, id uuidv7.UUID) error
	syncFunc       func(ctx context.Context, id uuidv7.UUID, syncedBy uuidv7.UUID) (*cashregister.CashRegister, error)
}

func (m *mockCashRegisterUseCase) CreateCashRegister(ctx context.Context, organizationID uuidv7.UUID, fiscalNumber, model string, createdBy uuidv7.UUID) (*cashregister.CashRegister, error) {
	if m.createFunc != nil {
...
func (m *mockCashRegisterUseCase) GetCashRegister(ctx context.Context, id uuidv7.UUID) (*cashregister.CashRegister, error) {
	if m.getFunc != nil {
...
func (m *mockCashRegisterUseCase) GetByFiscalNumber(ctx context.Context, fiscalNumber string) (*cashregister.CashRegister, error) {
	return nil, fmt.Errorf("not implemented")
}

func (m *mockCashRegisterUseCase) ListCashRegisters(ctx context.Context, organizationID *uuidv7.UUID) ([]*cashregister.CashRegister, error) {
	if m.listFunc != nil {
...
func (m *mockCashRegisterUseCase) ActivateCashRegister(ctx context.Context, id uuidv7.UUID, licenseKey string, activatedBy uuidv7.UUID) (*cashregister.CashRegister, error) {
...
func (m *mockCashRegisterUseCase) DeactivateCashRegister(ctx context.Context, id uuidv7.UUID, deactivatedBy uuidv7.UUID) (*cashregister.CashRegister, error) {
...
func (m *mockCashRegisterUseCase) UpdateCashRegister(ctx context.Context, cashRegister *cashregister.CashRegister) error {
...
func (m *mockCashRegisterUseCase) SyncCashRegister(ctx context.Context, id uuidv7.UUID, syncedBy uuidv7.UUID) (*cashregister.CashRegister, error) {
	if m.syncFunc != nil {
...
func TestCashRegisterHandler_Create_Success(t *testing.T) {
	...
	usecase := &mockCashRegisterUseCase{
		createFunc: func(ctx context.Context, organizationID uuidv7.UUID, fiscalNumber, model string, createdBy uuidv7.UUID) (*cashregister.CashRegister, error) {
			return cashregister.NewCashRegister(organizationID, fiscalNumber, model, createdBy)
		},
	}
...
func TestCashRegisterHandler_Create_ErrorMappings(t *testing.T) {
	testCases := []struct {
		...
		{name: "organization required", err: cashregister.ErrOrganizationIDRequired},
		{name: "fiscal number required", err: cashregister.ErrFiscalNumberRequired},
		{name: "model required", err: cashregister.ErrModelRequired},
		{name: "fiscal number exists", err: cashregister.ErrCashRegisterFiscalNumberExists},
	}
...
func TestCashRegisterHandler_Create_DuplicateFiscalNumber(t *testing.T) {
	...
	usecase := &mockCashRegisterUseCase{
		createFunc: func(ctx context.Context, organizationID uuidv7.UUID, fiscalNumber, model string, createdBy uuidv7.UUID) (*cashregister.CashRegister, error) {
			return nil, cashregister.ErrCashRegisterFiscalNumberExists
		},
	}
...
func TestCashRegisterHandler_GetByID_Success(t *testing.T) {
	...
	usecase := &mockCashRegisterUseCase{
		getFunc: func(ctx context.Context, id uuidv7.UUID) (*cashregister.CashRegister, error) {
			return cashregister.NewCashRegister(uuidv7.New(), "FN-200", "Test", uuidv7.New())
		},
	}
...
func TestCashRegisterHandler_List_Success(t *testing.T) {
	...
	usecase := &mockCashRegisterUseCase{
		listFunc: func(ctx context.Context, organizationID *uuidv7.UUID) ([]*cashregister.CashRegister, error) {
			cr, _ := cashregister.NewCashRegister(uuidv7.New(), "FN-201", "Model", uuidv7.New())
...
func TestCashRegisterHandler_Activate_Success(t *testing.T) {
	...
	usecase := &mockCashRegisterUseCase{
		activateFunc: func(ctx context.Context, id uuidv7.UUID, licenseKey string, activatedBy uuidv7.UUID) (*cashregister.CashRegister, error) {
			cr, _ := cashregister.NewCashRegister(uuidv7.New(), "FN-202", "Model", uuidv7.New())
...
func TestCashRegisterHandler_Activate_LicenseRequired(t *testing.T) {
	...
	usecase := &mockCashRegisterUseCase{
		activateFunc: func(ctx context.Context, id uuidv7.UUID, licenseKey string, activatedBy uuidv7.UUID) (*cashregister.CashRegister, error) {
			return nil, cashregister.ErrLicenseKeyRequired
		},
	}
...
func TestCashRegisterHandler_Sync_Success(t *testing.T) {
	...
	usecase := &mockCashRegisterUseCase{
		syncFunc: func(ctx context.Context, id uuidv7.UUID, syncedBy uuidv7.UUID) (*cashregister.CashRegister, error) {
			return cashregister.NewCashRegister(uuidv7.New(), "FN-208", "Model", uuidv7.New())
		},
	}
