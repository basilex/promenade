...
func TestNewInteraction(t *testing.T) {
	...
	t.Run("invalid type", func(t *testing.T) {
		...
		assert.Error(t, err)
		assert.True(t, errors.Is(err, interactionerrors.ErrInvalidInteractionType))
	})
	...
	t.Run("invalid direction", func(t *testing.T) {
		...
		assert.Error(t, err)
		assert.True(t, errors.Is(err, interactionerrors.ErrInvalidDirection))
	})
	...
	t.Run("empty subject", func(t *testing.T) {
		...
		assert.Error(t, err)
		assert.True(t, errors.Is(err, interactionerrors.ErrSubjectEmpty))
	})
	...
	t.Run("empty description", func(t *testing.T) {
		...
		assert.Error(t, err)
		assert.True(t, errors.Is(err, interactionerrors.ErrDescriptionEmpty))
	})
}
...
func TestInteraction_EndInteraction(t *testing.T) {
	...
	t.Run("end before start", func(t *testing.T) {
		...
		assert.Error(t, err)
		assert.True(t, errors.Is(err, interactionerrors.ErrEndedAtBeforeStartedAt))
	})
	...
	t.Run("already ended", func(t *testing.T) {
		...
		assert.Error(t, err)
		assert.ErrorIs(t, err, interactionerrors.ErrInteractionAlreadyEnded)
	})
}
...
func TestInteraction_SetFollowUp(t *testing.T) {
	...
	t.Run("require follow-up without date", func(t *testing.T) {
		...
		assert.Error(t, err)
		assert.True(t, errors.Is(err, interactionerrors.ErrFollowUpDateRequired))
	})
