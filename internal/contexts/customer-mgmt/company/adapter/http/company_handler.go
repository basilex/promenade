...
import (
	...
	"github.com/basilex/promenade/internal/contexts/customer-mgmt/company/usecase"
...
type CompanyHandler struct {
	companyUC usecase.ICompanyUseCase
}

// NewCompanyHandler creates a new company handler
func NewCompanyHandler(companyUC usecase.ICompanyUseCase) *CompanyHandler {
...
// @Accept json
// @Produce json
// @Param body body dto.CreateCompanyRequest true "Company creation data"
...
func (h *CompanyHandler) Create(c *gin.Context) {
	...
	phone, err := parsePhone(req.Phone)
	if err != nil {
...
func (h *CompanyHandler) ListBySize(c *gin.Context) {
	...
	size := aggregate.CompanySize(sizeStr)
	page, pageSize := parsePagination(c)
...
// @Produce json
// @Param id path string true "Company ID (UUID)"
// @Param body body dto.UpdateCompanyBasicInfoRequest true "Basic info update data"
// @Success 200 {object} dto.CompanyResponse
...
func (h *CompanyHandler) UpdateBasicInfo(c *gin.Context) {
	...
	var req dto.UpdateCompanyBasicInfoRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		response.ErrorResponse(c, http.StatusBadRequest, "VALIDATION_ERROR", err.Error())
		return
	}
	...
	comp, err := h.companyUC.UpdateCompanyBasicInfo(
		...
		companyType,
		req.TaxID,
		nil, // registrationNumber - not in dto.UpdateCompanyBasicInfoRequest
	)
	if err != nil {
		if errors.Is(err, company.ErrCompanyNotFound) {
			response.ErrorResponse(c, http.StatusNotFound, "COMPANY_NOT_FOUND", "Company not found")
...
// @Produce json
// @Param id path string true "Company ID (UUID)"
// @Param body body dto.UpdateCompanyContactInfoRequest true "Contact info update data"
// @Success 200 {object} dto.CompanyResponse
// @Failure 400 {object} response.Response "Invalid data"
// @Failure 404 {object} response.Response "Company not found"
// @Failure 500 {object} response.Response
...
func (h *CompanyHandler) UpdateContactInfo(c *gin.Context) {
	...
	var req dto.UpdateCompanyContactInfoRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		response.ErrorResponse(c, http.StatusBadRequest, "VALIDATION_ERROR", err.Error())
		return
	}
...
// @Produce json
// @Param id path string true "Company ID (UUID)"
// @Param body body dto.UpdateCompanyBusinessInfoRequest true "Business info update data"
// @Success 200 {object} dto.CompanyResponse
// @Failure 400 {object} response.Response "Invalid data"
// @Failure 404 {object} response.Response "Company not found"
// @Failure 500 {object} response.Response
...
func (h *CompanyHandler) UpdateBusinessInfo(c *gin.Context) {
	...
	var req dto.UpdateCompanyBusinessInfoRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		response.ErrorResponse(c, http.StatusBadRequest, "VALIDATION_ERROR", err.Error())
		return
	}
...
// @Produce json
// @Param id path string true "Company ID (UUID)"
// @Param body body dto.SetParentCompanyRequest true "Parent company ID"
// @Success 200 {object} dto.CompanyResponse
// @Failure 400 {object} response.Response "Invalid data"
// @Failure 404 {object} response.Response "Company not found"
// @Failure 500 {object} response.Response
...
func (h *CompanyHandler) SetParentCompany(c *gin.Context) {
	...
	var req dto.SetParentCompanyRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		response.ErrorResponse(c, http.StatusBadRequest, "VALIDATION_ERROR", err.Error())
		return
	}
...
// @Produce json
// @Param id path string true "Company ID (UUID)"
// @Param body body dto.UpdateCompanyDescriptionRequest true "Description update data"
// @Success 200 {object} dto.CompanyResponse
// @Failure 400 {object} response.Response "Invalid data"
// @Failure 404 {object} response.Response "Company not found"
// @Failure 500 {object} response.Response
...
func (h *CompanyHandler) UpdateDescription(c *gin.Context) {
	...
	var req dto.UpdateCompanyDescriptionRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		response.ErrorResponse(c, http.StatusBadRequest, "VALIDATION_ERROR", err.Error())
		return
	}
