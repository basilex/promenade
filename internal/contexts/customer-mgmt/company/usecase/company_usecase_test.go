...
func (m *MockRepository) Create(ctx context.Context, company *aggregate.Company) error {
	args := m.Called(ctx, company)
	return args.Error(0)
}

func (m *MockRepository) GetByID(ctx context.Context, id uuidv7.UUID) (*aggregate.Company, error) {
	args := m.Called(ctx, id)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
	return args.Get(0).(*aggregate.Company), args.Error(1)
}

func (m *MockRepository) GetByName(ctx context.Context, name string) (*aggregate.Company, error) {
...
func (m *MockRepository) GetByTaxID(ctx context.Context, taxID string) (*aggregate.Company, error) {
...
func (m *MockRepository) List(ctx context.Context, limit, offset int) ([]*aggregate.Company, int, error) {
	args := m.Called(ctx, limit, offset)
	if args.Get(0) == nil {
		return nil, args.Int(1), args.Error(2)
	}
	return args.Get(0).([]*aggregate.Company), args.Int(1), args.Error(2)
}

func (m *MockRepository) ListByIndustry(ctx context.Context, industry string, limit, offset int) ([]*aggregate.Company, int, error) {
...
func (m *MockRepository) ListBySize(ctx context.Context, size string, limit, offset int) ([]*aggregate.Company, int, error) {
...
func (m *MockRepository) ListSubsidiaries(ctx context.Context, parentID uuidv7.UUID) ([]*aggregate.Company, error) {
...
func (m *MockRepository) Update(ctx context.Context, company *aggregate.Company) error {
	args := m.Called(ctx, company)
	return args.Error(0)
}
...
func TestUseCase_CreateCompany_Success(t *testing.T) {
	...
	mockRepo.On("Create", ctx, mock.AnythingOfType("*aggregate.Company")).Return(nil)
	...
	assert.Equal(t, aggregate.CompanyTypeLLC, company.Type)
	assert.Equal(t, aggregate.CompanySizeLarge, company.Size)
...
func TestUseCase_CreateCompany_DuplicateName(t *testing.T) {
	...
	assert.Error(t, err)
	assert.True(t, errors.Is(err, companyerrors.ErrCompanyAlreadyExists))
...
func TestUseCase_CreateCompany_InvalidSize(t *testing.T) {
	...
	assert.Error(t, err)
	assert.Nil(t, company)
	assert.True(t, errors.Is(err, companyerrors.ErrCompanySizeInvalid))
	mockRepo.AssertExpectations(t)
}
...
func TestUseCase_GetCompany_Success(t *testing.T) {
	...
	expectedCompany, _ := aggregate.NewCompany("Acme Corp", "llc")
...
func TestUseCase_GetCompany_NotFound(t *testing.T) {
	...
	mockRepo.On("GetByID", ctx, companyID).Return(nil, companyerrors.ErrCompanyNotFound)

	company, err := uc.GetCompany(ctx, companyID)

	assert.Error(t, err)
	assert.True(t, errors.Is(err, companyerrors.ErrCompanyNotFound))
	assert.Nil(t, company)
	mockRepo.AssertExpectations(t)
}
...
func TestUseCase_UpdateCompanyBasicInfo_Success(t *testing.T) {
	...
	companyID := uuidv7.New()
	existingCompany, _ := aggregate.NewCompany("Old Name", "llc")
	...
	mockRepo.On("Update", ctx, mock.AnythingOfType("*aggregate.Company")).Return(nil)
	...
	assert.Equal(t, aggregate.CompanyTypeCorporation, company.Type)
	mockRepo.AssertExpectations(t)
}
...
func TestUseCase_UpdateCompanyContactInfo_Success(t *testing.T) {
	...
	companyID := uuidv7.New()
	existingCompany, _ := aggregate.NewCompany("Acme Corp", "llc")
	existingCompany.ID = companyID
...
func TestUseCase_UpdateCompanyBusinessInfo_Success(t *testing.T) {
	...
	assert.Equal(t, aggregate.CompanySizeEnterprise, company.Size)
...
func TestUseCase_ListCompanies_Success(t *testing.T) {
	...
	company1, _ := aggregate.NewCompany("Company A", "llc")
	company2, _ := aggregate.NewCompany("Company B", "corporation")
	companies := []*aggregate.Company{company1, company2}
...
func TestUseCase_ListCompaniesByIndustry_Success(t *testing.T) {
	...
	company1, _ := aggregate.NewCompany("Tech A", "llc")
	industry := "Technology"
	company1.Industry = &industry

	companies := []*aggregate.Company{company1}
...
func TestUseCase_ListCompaniesBySize_Success(t *testing.T) {
	...
	company1, _ := aggregate.NewCompany("Large Corp", "llc")
	companies := []*aggregate.Company{company1}
...
func TestUseCase_ListSubsidiaries_Success(t *testing.T) {
	...
	parentID := uuidv7.New()
	subsidiary1, _ := aggregate.NewCompany("Subsidiary A", "llc")
	subsidiary2, _ := aggregate.NewCompany("Subsidiary B", "llc")
	subsidiaries := []*aggregate.Company{subsidiary1, subsidiary2}
...
func TestUseCase_ListSubsidiaries_Empty(t *testing.T) {
	...
	mockRepo.On("ListSubsidiaries", ctx, parentID).Return([]*aggregate.Company{}, nil)
