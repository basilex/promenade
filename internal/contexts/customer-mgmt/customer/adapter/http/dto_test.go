...
func TestToCustomerResponse(t *testing.T) {
	...
	t.Run("B2B customer with company", func(t *testing.T) {
		...
		c, _ := customer.NewB2BCustomer("Jane Smith", "jane@company.com", "referral", companyID, assignedTo)
		c.ID = uuidv7.New()
	...
	t.Run("customer with user account", func(t *testing.T) {
		c, _ := customer.NewCustomer("Bob Test", "bob@example.com", "api", assignedTo)
		c.ID = uuidv7.New()
		userID := uuidv7.New()
	...
	t.Run("converted customer", func(t *testing.T) {
		c, _ := customer.NewCustomer("Alice Buyer", "alice@example.com", "website", assignedTo)
		c.ID = uuidv7.New()
		_ = c.QualifyAsProspect()
	...
	t.Run("churned customer", func(t *testing.T) {
		c, _ := customer.NewCustomer("Lost Customer", "lost@example.com", "website", assignedTo)
		c.ID = uuidv7.New()
		_ = c.QualifyAsProspect()
		_ = c.ConvertToCustomer()
	...
	t.Run("customer without phone", func(t *testing.T) {
		c, _ := customer.NewCustomer("No Phone", "nophone@example.com", "website", assignedTo)
		c.ID = uuidv7.New()
	...
	t.Run("customer with upgraded tier", func(t *testing.T) {
		c, _ := customer.NewCustomer("Premium User", "premium@example.com", "website", assignedTo)
		c.ID = uuidv7.New()
		_ = c.QualifyAsProspect()
		_ = c.ConvertToCustomer()
...
func TestToCustomerListResponse(t *testing.T) {
	...
	t.Run("multiple customers", func(t *testing.T) {
		c1, _ := customer.NewCustomer("Customer 1", "c1@example.com", "website", assignedTo)
		c1.ID = uuidv7.New()

		c2, _ := customer.NewCustomer("Customer 2", "c2@example.com", "api", assignedTo)
		c2.ID = uuidv7.New()
		_ = c2.QualifyAsProspect()

		c3, _ := customer.NewCustomer("Customer 3", "c3@example.com", "referral", assignedTo)
		c3.ID = uuidv7.New()
		_ = c3.QualifyAsProspect()
		_ = c3.ConvertToCustomer()

		customers := []*customer.Customer{c1, c2, c3}
		resp := ToCustomerListResponse(customers)
	...
	t.Run("mixed B2C and B2B", func(t *testing.T) {
		c1, _ := customer.NewCustomer("B2C Customer", "b2c@example.com", "website", assignedTo)
		c1.ID = uuidv7.New()

		companyID := uuidv7.New()
		c2, _ := customer.NewB2BCustomer("B2B Customer", "b2b@company.com", "referral", companyID, assignedTo)
		c2.ID = uuidv7.New()
...
func TestToCustomerStatsResponse(t *testing.T) {
	t.Run("complete stats", func(t *testing.T) {
		stats := &customer.CustomerStats{
			...
			ByStatus: map[customer.CustomerStatus]int{
				...
				customer.CustomerStatusCustomer: 25,
				customer.CustomerStatusChurned:  20,
			},
			ByTier: map[customer.CustomerTier]int{
				customer.CustomerTierFree:       60,
				customer.CustomerTierBasic:      20,
				customer.CustomerTierPro:        15,
	...
	t.Run("empty stats", func(t *testing.T) {
		stats := &customer.CustomerStats{
			...
			ActiveCustomers:  0,
			ChurnedCustomers: 0,
			ByStatus:         make(map[customer.CustomerStatus]int),
			ByTier:           make(map[customer.CustomerTier]int),
		}
	...
	t.Run("partial stats", func(t *testing.T) {
		stats := &customer.CustomerStats{
			...
			ChurnedCustomers: 10,
			ByStatus: map[customer.CustomerStatus]int{
				customer.CustomerStatusLead:     20,
				customer.CustomerStatusProspect: 20,
			},
			ByTier: map[customer.CustomerTier]int{
				customer.CustomerTierFree:  45,
				customer.CustomerTierBasic: 5,
			},
		}
...
func TestCustomerResponse_JSONSerialization(t *testing.T) {
	...
	t.Run("includes optional fields when present", func(t *testing.T) {
		companyID := uuidv7.New()
		c, _ := customer.NewB2BCustomer("Test User", "test@example.com", "website", companyID, assignedTo)
		c.ID = uuidv7.New()
		phone, _ := valueobject.NewPhone("+380501234567")
		c.Phone = &phone
...
func TestCustomerStatsResponse_JSONSerialization(t *testing.T) {
	t.Run("serializes stats to JSON", func(t *testing.T) {
		stats := &customer.CustomerStats{
			...
			ChurnedCustomers: 20,
			ByStatus: map[customer.CustomerStatus]int{
				customer.CustomerStatusLead: 50,
			},
			ByTier: map[customer.CustomerTier]int{
				customer.CustomerTierFree: 80,
			},
		}
...
func TestCustomerResponse_HelperFlags(t *testing.T) {
	...
	t.Run("lead status flags", func(t *testing.T) {
		c, _ := customer.NewCustomer("Lead", "lead@example.com", "website", assignedTo)
		resp := ToCustomerResponse(c)
	...
	t.Run("prospect status flags", func(t *testing.T) {
		c, _ := customer.NewCustomer("Prospect", "prospect@example.com", "website", assignedTo)
		_ = c.QualifyAsProspect()
		resp := ToCustomerResponse(c)
	...
	t.Run("active customer flags", func(t *testing.T) {
		c, _ := customer.NewCustomer("Customer", "customer@example.com", "website", assignedTo)
		_ = c.QualifyAsProspect()
		_ = c.ConvertToCustomer()
		resp := ToCustomerResponse(c)
	...
	t.Run("churned customer flags", func(t *testing.T) {
		c, _ := customer.NewCustomer("Churned", "churned@example.com", "website", assignedTo)
		_ = c.QualifyAsProspect()
		_ = c.ConvertToCustomer()
		_ = c.Churn("left")
		resp := ToCustomerResponse(c)
...
func TestCustomerResponse_Timestamps(t *testing.T) {
	...
	t.Run("includes created_at and updated_at", func(t *testing.T) {
		c, _ := customer.NewCustomer("Test", "test@example.com", "website", assignedTo)
		resp := ToCustomerResponse(c)
