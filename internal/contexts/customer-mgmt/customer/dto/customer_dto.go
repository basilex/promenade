...
func ToCustomerResponse(c *aggregate.Customer) *CustomerResponse {
...
func ToCustomerListResponse(customers []*aggregate.Customer) []*CustomerResponse {
...
func ToCustomerStatsResponse(stats *usecase.CustomerStats) *CustomerStatsResponse {
