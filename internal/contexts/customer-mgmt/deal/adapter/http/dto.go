...
func ToDealResponse(d *deal.Deal) DealResponse {
	resp := DealResponse{
		ID:                d.ID.String(),
...
func ToDealListResponse(deals []*deal.Deal) []*DealResponse {
...
func ToPipelineStatsResponse(stats map[deal.DealStage]int64) PipelineStatsResponse {
