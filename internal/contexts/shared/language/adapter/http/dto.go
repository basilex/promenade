...
import "github.com/basilex/promenade/internal/contexts/shared/language"
...
func ToLanguageResponse(l *language.Language) LanguageResponse {
...
func ToLanguageResponses(languages []*language.Language) []LanguageResponse {
