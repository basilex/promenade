...
func (m *MockRepository) GetByID(ctx context.Context, id uuidv7.UUID) (*Order, error) {
...
func (m *MockRepository) GetByOrderNumber(ctx context.Context, orderNumber string) (*Order, error) {
...
func (m *MockRepository) ListByCustomerID(ctx context.Context, customerID uuidv7.UUID, page, pageSize int) ([]*Order, int64, error) {
...
func (m *MockRepository) ListByStatus(ctx context.Context, status OrderStatus, page, pageSize int) ([]*Order, int64, error) {
...
func (m *MockRepository) List(ctx context.Context, page, pageSize int) ([]*Order, int64, error) {
...
func (m *MockRepository) GetLines(ctx context.Context, orderID uuidv7.UUID) ([]OrderLine, error) {
	args := m.Called(ctx, orderID)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
	return args.Get(0).([]OrderLine), args.Error(1)
}

func (m *MockRepository) CreateLine(ctx context.Context, line *OrderLine) error {
	args := m.Called(ctx, line)
	return args.Error(0)
}

func (m *MockRepository) UpdateLine(ctx context.Context, line *OrderLine) error {
	args := m.Called(ctx, line)
	return args.Error(0)
}
...
func TestUseCase_AddOrderLine(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			mockSetup: func(repo *MockRepository) {
				existingOrder, _ := NewOrder(customerID, "USD")
				existingOrder.ID = orderID
				repo.On("GetByID", mock.Anything, orderID).Return(existingOrder, nil)
				repo.On("GetLines", mock.Anything, orderID).Return([]OrderLine{}, nil)
				repo.On("CreateLine", mock.Anything, mock.AnythingOfType("*order.OrderLine")).Return(nil)
				repo.On("Update", mock.Anything, mock.AnythingOfType("*order.Order")).Return(nil)
			},
			wantErr: false,
		},
		{
