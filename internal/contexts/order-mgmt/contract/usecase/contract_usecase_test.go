...
type MockContractRepository struct {
	CreateFunc             func(ctx context.Context, c *aggregate.Contract) error
	GetByIDFunc            func(ctx context.Context, id uuidv7.UUID) (*aggregate.Contract, error)
	UpdateFunc             func(ctx context.Context, c *aggregate.Contract) error
	DeleteFunc             func(ctx context.Context, id uuidv7.UUID) error
	ListFunc               func(ctx context.Context, offset, limit int) ([]*aggregate.Contract, int, error)
	GetByOrderFunc         func(ctx context.Context, orderID uuidv7.UUID) ([]*aggregate.Contract, error)
	GetByCustomerFunc      func(ctx context.Context, customerID uuidv7.UUID) ([]*aggregate.Contract, error)
	GetActiveContractsFunc func(ctx context.Context) ([]*aggregate.Contract, error)
	ListByCustomerFunc     func(ctx context.Context, customerID uuidv7.UUID, limit, offset int) ([]*aggregate.Contract, int, error)
	ListByStatusFunc       func(ctx context.Context, status aggregate.ContractStatus, limit, offset int) ([]*aggregate.Contract, int, error)
	ListExpiringSoonFunc   func(ctx context.Context, days int) ([]*aggregate.Contract, error)
	CountByCustomerFunc    func(ctx context.Context, customerID uuidv7.UUID) (int, error)
	CountByStatusFunc      func(ctx context.Context, status aggregate.ContractStatus) (int, error)
	ExistsFunc             func(ctx context.Context, id uuidv7.UUID) (bool, error)
}

// Implement IContractRepository interface with nil checks
func (m *MockContractRepository) Create(ctx context.Context, c *aggregate.Contract) error {
	if m.CreateFunc != nil {
...
func (m *MockContractRepository) GetByID(ctx context.Context, id uuidv7.UUID) (*aggregate.Contract, error) {
...
func (m *MockContractRepository) Update(ctx context.Context, c *aggregate.Contract) error {
	if m.UpdateFunc != nil {
...
func (m *MockContractRepository) List(ctx context.Context, offset, limit int) ([]*aggregate.Contract, int, error) {
	if m.ListFunc != nil {
...
func (m *MockContractRepository) GetByOrder(ctx context.Context, orderID uuidv7.UUID) ([]*aggregate.Contract, error) {
...
func (m *MockContractRepository) GetByCustomer(ctx context.Context, customerID uuidv7.UUID) ([]*aggregate.Contract, error) {
...
func (m *MockContractRepository) GetActiveContracts(ctx context.Context) ([]*aggregate.Contract, error) {
...
func (m *MockContractRepository) ListByCustomer(ctx context.Context, customerID uuidv7.UUID, limit, offset int) ([]*aggregate.Contract, int, error) {
...
func (m *MockContractRepository) ListByStatus(ctx context.Context, status aggregate.ContractStatus, limit, offset int) ([]*aggregate.Contract, int, error) {
...
func (m *MockContractRepository) ListExpiringSoon(ctx context.Context, days int) ([]*aggregate.Contract, error) {
...
func (m *MockContractRepository) CountByStatus(ctx context.Context, status aggregate.ContractStatus) (int, error) {
...
func fakeContract() *aggregate.Contract {
	orderID := uuidv7.New()
	customerID := uuidv7.New()
	return aggregate.NewContract(orderID, customerID, "Test Terms")
}
...
func TestCreateContract_Success(t *testing.T) {
	...
	uc := NewContractUseCase(mockRepo)
	...
	assert.Equal(t, aggregate.ContractStatusDraft, result.Status)
}
...
func TestSubmitForSignature_Success(t *testing.T) {
	...
	require.NoError(t, err)
	assert.Equal(t, aggregate.ContractStatusPendingSignature, testContract.Status)
}
...
func TestSubmitForSignature_InvalidState(t *testing.T) {
	...
	require.Error(t, err)
	assert.True(t, errors.Is(err, contracterrors.ErrCannotSubmitNonDraft))
}
...
func TestSignContract_Success(t *testing.T) {
	...
	require.NoError(t, err)
	assert.Equal(t, aggregate.ContractStatusActive, testContract.Status)
...
func TestCompleteContract_Success(t *testing.T) {
	...
	require.NoError(t, err)
	assert.Equal(t, aggregate.ContractStatusCompleted, testContract.Status)
}
...
func TestTerminateContract_Success(t *testing.T) {
	...
	require.NoError(t, err)
	assert.Equal(t, aggregate.ContractStatusTerminated, testContract.Status)
...
func TestListContractsByOrder_Success(t *testing.T) {
	orderID := uuidv7.New()
	expectedContracts := []*aggregate.Contract{fakeContract(), fakeContract()}

	mockRepo := &MockContractRepository{
		GetByOrderFunc: func(ctx context.Context, oID uuidv7.UUID) ([]*aggregate.Contract, error) {
...
func TestListContractsByCustomer_Success(t *testing.T) {
	customerID := uuidv7.New()
	expectedContracts := []*aggregate.Contract{fakeContract()}
	expectedTotal := 1

	mockRepo := &MockContractRepository{
		ListByCustomerFunc: func(ctx context.Context, cID uuidv7.UUID, limit, offset int) ([]*aggregate.Contract, int, error) {
...
func TestListContractsByStatus_Success(t *testing.T) {
	...
	mockRepo := &MockContractRepository{
		ListByStatusFunc: func(ctx context.Context, status aggregate.ContractStatus, limit, offset int) ([]*aggregate.Contract, int, error) {
			assert.Equal(t, aggregate.ContractStatusActive, status)
			return expectedContracts, expectedTotal, nil
		},
	}
	...
	result, total, err := uc.ListContractsByStatus(ctx, aggregate.ContractStatusActive, 1, 10)
...
func TestListExpiringSoon_Success(t *testing.T) {
	...
	mockRepo := &MockContractRepository{
		ListExpiringSoonFunc: func(ctx context.Context, d int) ([]*aggregate.Contract, error) {
