...
func TestContract_Validate(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			wantErr:     true,
			expectedErr: contracterrors.ErrOrderIDRequired,
		},
		{
			...
			wantErr:     true,
			expectedErr: contracterrors.ErrCustomerIDRequired,
		},
		{
			name: "missing terms",
			setup: func() *Contract {
			...
			wantErr:     true,
			expectedErr: contracterrors.ErrTermsRequired,
		},
	}
...
func TestContract_SubmitForSignature(t *testing.T) {
	...
	t.Run("cannot submit non-draft contract", func(t *testing.T) {
		...
		assert.Error(t, err)
		assert.ErrorIs(t, err, contracterrors.ErrCannotSubmitNonDraft)
	})
}
...
func TestContract_Sign(t *testing.T) {
	...
	t.Run("cannot sign non-pending contract", func(t *testing.T) {
		...
		assert.Error(t, err)
		assert.ErrorIs(t, err, contracterrors.ErrCannotSignNonPending)
	})
	...
	t.Run("missing signer name", func(t *testing.T) {
		...
		assert.Error(t, err)
		assert.ErrorIs(t, err, contracterrors.ErrSignerNameRequired)
	})
	...
	t.Run("missing signer email", func(t *testing.T) {
		...
		assert.Error(t, err)
		assert.ErrorIs(t, err, contracterrors.ErrSignerEmailRequired)
	})
}
...
func TestContract_Complete(t *testing.T) {
	...
	t.Run("cannot complete non-active contract", func(t *testing.T) {
		...
		assert.Error(t, err)
		assert.ErrorIs(t, err, contracterrors.ErrCannotCompleteNonActive)
	})
}
...
func TestContract_Terminate(t *testing.T) {
	...
	t.Run("cannot terminate non-active contract", func(t *testing.T) {
		...
		assert.Error(t, err)
		assert.ErrorIs(t, err, contracterrors.ErrCannotTerminateNonActive)
	})
	...
	t.Run("missing termination reason", func(t *testing.T) {
		...
		assert.Error(t, err)
		assert.ErrorIs(t, err, contracterrors.ErrTerminationReasonRequired)
	})
}
...
func TestContract_Renew(t *testing.T) {
	...
	t.Run("cannot renew draft contract", func(t *testing.T) {
		...
		assert.Error(t, err)
		assert.ErrorIs(t, err, contracterrors.ErrCannotRenewInactiveContract)
	})
}
...
func TestContract_SetExpirationDate(t *testing.T) {
	...
	t.Run("cannot set expiration for active contract", func(t *testing.T) {
		...
		assert.Error(t, err)
		assert.ErrorIs(t, err, contracterrors.ErrCannotSetExpirationForActive)
	})
	...
	t.Run("cannot set past expiration date", func(t *testing.T) {
		...
		assert.Error(t, err)
		assert.ErrorIs(t, err, contracterrors.ErrExpirationInPast)
	})
}
