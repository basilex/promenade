...
import (
	...
	"github.com/basilex/promenade/internal/contexts/identity/user/dto"
	"github.com/basilex/promenade/internal/contexts/identity/user/usecase"
...
func NewUserHandler(uc usecase.IUserUseCase, jwtManager *jwt.Manager, tokenRevoker *jwt.TokenRevoker) *UserHandler {
	return &UserHandler{
		usecase:      uc,
...
func (h *UserHandler) Register(c *gin.Context) {
	...
	response.Created(c, dto.ToUserResponse(created))
}
...
func (h *UserHandler) Login(c *gin.Context) {
	...
	if err != nil {
		if errors.Is(err, usererrors.ErrInvalidCredentials) {
			response.Unauthorized(c, "invalid credentials")
			return
		}
		if errors.Is(err, usererrors.ErrAccountLocked) {
			response.Unauthorized(c, "account is locked")
			return
		}
		if errors.Is(err, usererrors.ErrAccountNotActive) {
...
func (h *UserHandler) GetByID(c *gin.Context) {
	...
	response.Success(c, dto.ToUserResponse(userEntity))
}
...
func (h *UserHandler) ChangePassword(c *gin.Context) {
	...
	if err != nil {
		...
		if errors.Is(err, usererrors.ErrInvalidPassword) {
...
func (h *UserHandler) List(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{
		"status": "success",
		"data":   dto.ToUserListResponse(users),
		"pagination": gin.H{
			"total":     total,
			"page":      page,
			"page_size": pageSize,
