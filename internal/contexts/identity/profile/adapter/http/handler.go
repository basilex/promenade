...
type ProfileHandler struct {
	usecase profile.IUseCase
}

// NewProfileHandler creates a new profile handler
func NewProfileHandler(usecase profile.IUseCase) *ProfileHandler {
...
func (h *ProfileHandler) Create(c *gin.Context) {
	...
	response.Created(c, ToProfileResponse(profileEntity))
}
...
func (h *ProfileHandler) GetByID(c *gin.Context) {
	...
	response.Success(c, ToProfileResponse(profileEntity))
}
...
func (h *ProfileHandler) ListPublic(c *gin.Context) {
	...
	response.Success(c, ToProfileResponseList(profiles))
}
