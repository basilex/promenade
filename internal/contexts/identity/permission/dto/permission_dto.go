...
func ToPermissionResponse(p *aggregate.Permission) PermissionResponse {
...
func ToPermissionListResponse(perms []*aggregate.Permission, total, limit, offset int) PermissionListResponse {
