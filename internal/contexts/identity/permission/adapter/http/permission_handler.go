...
import (
	...
	"github.com/basilex/promenade/internal/contexts/identity/permission/dto"
	"github.com/basilex/promenade/internal/contexts/identity/permission/usecase"
...
func NewPermissionHandler(usecase usecase.IPermissionUseCase) *PermissionHandler {
...
func (h *PermissionHandler) Create(c *gin.Context) {
	...
	if err != nil {
		if errors.Is(err, permissionerrors.ErrPermissionNameExists) {
	...
	response.Created(c, dto.ToPermissionResponse(created))
}
...
func (h *PermissionHandler) GetByID(c *gin.Context) {
	...
	response.Success(c, dto.ToPermissionResponse(found))
}
...
func (h *PermissionHandler) Update(c *gin.Context) {
	...
	response.Success(c, dto.ToPermissionResponse(updated))
}
...
func (h *PermissionHandler) List(c *gin.Context) {
	...
	response.Success(c, dto.ToPermissionListResponse(perms, total, limit, offset))
}
...
func (h *PermissionHandler) GetRolePermissions(c *gin.Context) {
	...
	for i, p := range perms {
		result[i] = dto.ToPermissionResponse(p)
	}
