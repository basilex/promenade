...
func TestToContactResponse(t *testing.T) {
	...
	t.Run("email contact", func(t *testing.T) {
		...
		c := &contactaggregate.Contact{
			BaseAggregate: aggregate.BaseAggregate{ID: contactID},
			UserID:        userID,
			Type:          contactaggregate.ContactTypeEmail,
			Label:         "Work",
			Email:         &email,
			IsPrimary:     true,
			IsVerified:    false,
	...
	t.Run("phone contact", func(t *testing.T) {
		...
		c := &contactaggregate.Contact{
			BaseAggregate: aggregate.BaseAggregate{ID: contactID},
			UserID:        userID,
			Type:          contactaggregate.ContactTypePhone,
			Label:         "Mobile",
			Phone:         &phone,
			IsPrimary:     false,
			IsVerified:    true,
	...
	t.Run("address contact", func(t *testing.T) {
		...
		c := &contactaggregate.Contact{
			BaseAggregate: aggregate.BaseAggregate{ID: contactID},
			UserID:        userID,
			Type:          contactaggregate.ContactTypeAddress,
			Label:         "Home",
			Address:       &addr,
			IsPrimary:     false,
			IsVerified:    false,
...
func TestToContactListResponse(t *testing.T) {
	...
	contacts := []*contactaggregate.Contact{
		{
