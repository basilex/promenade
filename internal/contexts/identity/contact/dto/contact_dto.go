...
func ToContactResponse(c *aggregate.Contact) ContactResponse {
...
func ToContactListResponse(contacts []*aggregate.Contact) []ContactResponse {
...
func CreateContactFromRequest(userID string, req CreateContactRequest) (*aggregate.Contact, error) {
	// Parse user ID
	...
	contactType := aggregate.ContactType(req.Type)
	...
	case aggregate.ContactTypeEmail:
		...
		return aggregate.NewEmailContact(userUUID, *req.Email, req.Label)
