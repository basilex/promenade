...
func (m *MockRepository) Create(ctx context.Context, contact *aggregate.Contact) error {
	args := m.Called(ctx, contact)
	return args.Error(0)
}

func (m *MockRepository) GetByID(ctx context.Context, id uuidv7.UUID) (*aggregate.Contact, error) {
	args := m.Called(ctx, id)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
	return args.Get(0).(*aggregate.Contact), args.Error(1)
}

func (m *MockRepository) GetByUserID(ctx context.Context, userID uuidv7.UUID) ([]*aggregate.Contact, error) {
...
func (m *MockRepository) GetByUserIDAndType(ctx context.Context, userID uuidv7.UUID, contactType aggregate.ContactType) ([]*aggregate.Contact, error) {
...
func (m *MockRepository) GetPrimaryByUserIDAndType(ctx context.Context, userID uuidv7.UUID, contactType aggregate.ContactType) (*aggregate.Contact, error) {
	args := m.Called(ctx, userID, contactType)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
...
func (m *MockRepository) Update(ctx context.Context, contact *aggregate.Contact) error {
	args := m.Called(ctx, contact)
	return args.Error(0)
}
...
func (m *MockRepository) ExistsPrimaryForUserAndType(ctx context.Context, userID uuidv7.UUID, contactType aggregate.ContactType) (bool, error) {
	args := m.Called(ctx, userID, contactType)
...
func TestUseCase_CreateEmailContact(t *testing.T) {
	...
	t.Run("success - non-primary", func(t *testing.T) {
		...
		assert.Equal(t, aggregate.ContactTypeEmail, contact.Type)
	...
	t.Run("success - primary", func(t *testing.T) {
		...
		repo.On("ExistsPrimaryForUserAndType", ctx, userID, aggregate.ContactTypeEmail).Return(false, nil)
		repo.On("Create", ctx, mock.Anything).Return(nil)
	...
	t.Run("error - primary already exists", func(t *testing.T) {
		...
		repo.On("ExistsPrimaryForUserAndType", ctx, userID, aggregate.ContactTypeEmail).Return(true, nil)

		_, err := uc.CreateEmailContact(ctx, userID, "test@example.com", "Work", true)

		assert.Error(t, err)
		assert.True(t, errors.Is(err, contacterrors.ErrPrimaryContactExists))
		repo.AssertExpectations(t)
	})
...
func TestUseCase_CreatePhoneContact(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		require.NoError(t, err)
		assert.NotNil(t, contact)
		assert.Equal(t, aggregate.ContactTypePhone, contact.Type)
		repo.AssertExpectations(t)
	})
	...
	t.Run("error - primary already exists", func(t *testing.T) {
		...
		repo.On("ExistsPrimaryForUserAndType", ctx, userID, aggregate.ContactTypePhone).Return(true, nil)
...
func TestUseCase_CreateAddressContact(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		require.NoError(t, err)
		assert.NotNil(t, contact)
		assert.Equal(t, aggregate.ContactTypeAddress, contact.Type)
		repo.AssertExpectations(t)
	})
}
...
func TestUseCase_GetContact(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		expectedContact, _ := aggregate.NewEmailContact(uuidv7.New(), "test@example.com", "Work")
...
func TestUseCase_GetUserContacts(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		contact1, _ := aggregate.NewEmailContact(userID, "test1@example.com", "Work")
		contact2, _ := aggregate.NewPhoneContact(userID, "+380501234567", "Mobile")
		expectedContacts := []*aggregate.Contact{contact1, contact2}
...
func TestUseCase_SetAsPrimary(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		contact, _ := aggregate.NewEmailContact(uuidv7.New(), "test@example.com", "Work")
