...
func (m *MockRepository) Create(ctx context.Context, script *aggregate.Script) error {
	args := m.Called(ctx, script)
	return args.Error(0)
}

func (m *MockRepository) Update(ctx context.Context, script *aggregate.Script) error {
	args := m.Called(ctx, script)
	return args.Error(0)
}
...
func (m *MockRepository) CreateVersion(ctx context.Context, version *aggregate.ScriptVersion) error {
	args := m.Called(ctx, version)
	return args.Error(0)
}

func (m *MockRepository) ListVersions(ctx context.Context, scriptID uuidv7.UUID, limit, offset int) ([]*aggregate.ScriptVersion, int, error) {
	args := m.Called(ctx, scriptID, limit, offset)
	if args.Get(0) == nil {
		return nil, args.Int(1), args.Error(2)
	}
	return args.Get(0).([]*aggregate.ScriptVersion), args.Int(1), args.Error(2)
}

func (m *MockRepository) GetByID(ctx context.Context, scriptID uuidv7.UUID) (*aggregate.Script, error) {
	args := m.Called(ctx, scriptID)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
	return args.Get(0).(*aggregate.Script), args.Error(1)
}

func (m *MockRepository) GetByName(ctx context.Context, name string) (*aggregate.Script, error) {
...
func (m *MockRepository) List(ctx context.Context, status aggregate.ScriptStatus, limit, offset int) ([]*aggregate.Script, int, error) {
	args := m.Called(ctx, status, limit, offset)
	if args.Get(0) == nil {
		return nil, args.Int(1), args.Error(2)
	}
	return args.Get(0).([]*aggregate.Script), args.Int(1), args.Error(2)
}

func (m *MockRepository) ListAll(ctx context.Context, limit, offset int) ([]*aggregate.Script, int, error) {
...
func (m *MockRepository) CreateExecution(ctx context.Context, execution *aggregate.ScriptExecution) error {
	args := m.Called(ctx, execution)
	return args.Error(0)
}

func (m *MockRepository) GetExecutionByID(ctx context.Context, executionID uuidv7.UUID) (*aggregate.ScriptExecution, error) {
	args := m.Called(ctx, executionID)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
	return args.Get(0).(*aggregate.ScriptExecution), args.Error(1)
}

func (m *MockRepository) GetExecutionHistory(ctx context.Context, scriptID uuidv7.UUID, limit, offset int) ([]*aggregate.ScriptExecution, int, error) {
	args := m.Called(ctx, scriptID, limit, offset)
	if args.Get(0) == nil {
		return nil, args.Int(1), args.Error(2)
	}
	return args.Get(0).([]*aggregate.ScriptExecution), args.Int(1), args.Error(2)
}

func (m *MockRepository) GetRecentExecutions(ctx context.Context, limit int) ([]*aggregate.ScriptExecution, error) {
...
func TestUseCase_ExecuteScript(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		uc := NewScriptUseCase(repo, engine)

		script := &aggregate.Script{
			Name:   "test_script",
			Code:   "return 2 + 2",
			Status: aggregate.ScriptStatusActive,
		}
	...
	t.Run("script not active", func(t *testing.T) {
		...
		script := &aggregate.Script{
			...
			Status: aggregate.ScriptStatusInactive,
		}
...
func TestUseCase_CreateScript(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		assert.Equal(t, aggregate.ScriptStatusDraft, script.Status)
	})
	...
	t.Run("validation error", func(t *testing.T) {
		...
		assert.Error(t, err)
		assert.Nil(t, script)
		assert.ErrorIs(t, err, scripterrors.ErrScriptSyntaxInvalid)
	})
	...
	t.Run("repository error", func(t *testing.T) {
		...
		assert.Error(t, err)
		assert.Nil(t, script)
		assert.ErrorIs(t, err, scripterrors.ErrScriptCreateFailed)
	})
}
...
func TestUseCase_UpdateScript(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		existingScript := &aggregate.Script{
			Name:    "test_script",
			Code:    "return 2 + 2",
			Version: 1,
		}
...
func TestUseCase_ActivateScript(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		script := &aggregate.Script{
			Name:   "test_script",
			Status: aggregate.ScriptStatusDraft,
		}
		script.ID = uuidv7.New()
		...
		assert.NoError(t, err)
		assert.Equal(t, aggregate.ScriptStatusActive, script.Status)
	})
...
func TestUseCase_DeactivateScript(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		assert.NoError(t, err)
		assert.Equal(t, aggregate.ScriptStatusInactive, script.Status)
	})
}
...
func TestUseCase_ArchiveScript(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		assert.NoError(t, err)
		assert.Equal(t, aggregate.ScriptStatusArchived, script.Status)
	})
}
...
func TestUseCase_GetScript(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		expectedScript := &aggregate.Script{Name: "test_script"}
...
func TestUseCase_ListScripts(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		expectedScripts := []*aggregate.Script{
			{Name: "script1"},
			{Name: "script2"},
		}

		repo.On("List", ctx, aggregate.ScriptStatusActive, 10, 0).Return(expectedScripts, 2, nil)

		scripts, total, err := uc.ListScripts(ctx, aggregate.ScriptStatusActive, 10, 0)
...
func TestUseCase_GetExecutionHistory(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		expectedExecutions := []*aggregate.ScriptExecution{
