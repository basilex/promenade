...
func (e *ScriptExecution) Validate() error {
	...
	if e.ScriptName == "" {
		return scripterrors.ErrScriptExecutionNameEmpty
	}
	if e.ExecutedBy == uuidv7.Nil {
		return scripterrors.ErrScriptExecutionExecutedByNil
	}
	if e.DurationMs < 0 {
		return scripterrors.ErrScriptExecutionDurationNegative
	}
	return nil
}
