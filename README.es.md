...
| ------------------------------------------------------------------ | ----------------------------------------------------------------------------- |
| **[docs/ARCHITECTURE_OVERVIEW.md](docs/ARCHITECTURE_OVERVIEW.md)** | Diagramas visuales de arquitectura, responsabilidades de capas, ciclo de vida |
| **[docs/ARCHITECTURE_QUICKREF.md](docs/ARCHITECTURE_QUICKREF.md)** | Referencia rápida, árboles de decisión, errores comunes                       |
| **[docs/ARCHITECTURE_AUDIT.md](docs/ARCHITECTURE_AUDIT.md)**       | Auditoría de cumplimiento de arquitectura, checklist de verificación          |
...
| **[docs/MODULE_DEVELOPMENT.md](docs/MODULE_DEVELOPMENT.md)**                 | Creación de nuevos módulos, mejores prácticas               |
| **[docs/MODULE_INDEPENDENCE.md](docs/MODULE_INDEPENDENCE.md)**               | Reglas de autonomía de módulos, gestión de dependencias     |
| **[docs/MODULE_CONFIG_ARCHITECTURE.md](docs/MODULE_CONFIG_ARCHITECTURE.md)** | Sistema de configuración de módulos                         |
...
| **[docs/PURGE_ARCHITECTURE.md](docs/PURGE_ARCHITECTURE.md)**         | Sistema automatizado de purga de datos (basado en registro) |
...
| **[docs/TESTING_GUIDE.md](docs/TESTING_GUIDE.md)**                   | Mejores prácticas de pruebas, patrones      |
| **[docs/TESTING_INFRASTRUCTURE.md](docs/TESTING_INFRASTRUCTURE.md)** | Configuración de infraestructura de pruebas |

### Referencias Técnicas

| Documento                                          | Descripción                                               |
| -------------------------------------------------- | --------------------------------------------------------- |
| **[docs/UUID_V7_GUIDE.md](docs/UUID_V7_GUIDE.md)** | Implementación y beneficios del UUID v7                   |
| **[docs/SOFT_DELETE.md](docs/SOFT_DELETE.md)**     | Patrón soft delete para contenido de usuarios             |
| **[docs/AUTHORIZATION.md](docs/AUTHORIZATION.md)** | Sistema RBAC (4 roles, permisos wildcard)                 |
...
| **[docs/INDEX.md](docs/INDEX.md)**                 | Índice completo de documentación con rutas de aprendizaje |
...
**Guía completa RBAC**: [docs/AUTHORIZATION.md](docs/AUTHORIZATION.md)
...
- [docs/TESTING_GUIDE.md](docs/TESTING_GUIDE.md) - Mejores prácticas
...
**Guía de configuración**: [docs/MODULE_CONFIG_ARCHITECTURE.md](docs/MODULE_CONFIG_ARCHITECTURE.md)
...
**Guía completa**: [docs/MODULE_DEVELOPMENT.md](docs/MODULE_DEVELOPMENT.md)
...
1. **Inicio**: [docs/ARCHITECTURE_QUICKREF.md](docs/ARCHITECTURE_QUICKREF.md) - Visión general de 15 minutos
...
4. **Práctica**: Crear un módulo simple siguiendo [docs/MODULE_DEVELOPMENT.md](docs/MODULE_DEVELOPMENT.md)
...
4. **Configuración**: [docs/MODULE_CONFIG_ARCHITECTURE.md](docs/MODULE_CONFIG_ARCHITECTURE.md)

### Para Arquitectos

1. **Visión General de Arquitectura**: [docs/ARCHITECTURE_OVERVIEW.md](docs/ARCHITECTURE_OVERVIEW.md)
2. **Auditoría & Verificación**: [docs/ARCHITECTURE_AUDIT.md](docs/ARCHITECTURE_AUDIT.md)
3. **Independencia de Módulos**: [docs/MODULE_INDEPENDENCE.md](docs/MODULE_INDEPENDENCE.md)
...
3. Seguir principios de arquitectura (vea [docs/ARCHITECTURE_QUICKREF.md](docs/ARCHITECTURE_QUICKREF.md))
