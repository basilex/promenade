...
COMMENT ON TABLE comment_likes IS 'Stores comment likes to prevent duplicate likes and enable unlike functionality';
COMMENT ON COLUMN comment_likes.comment_id IS 'Reference to the liked comment';
COMMENT ON COLUMN comment_likes.user_id IS 'Reference to the user who liked the comment';
