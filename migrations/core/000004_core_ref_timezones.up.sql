...
CREATE TABLE IF NOT EXISTS core_timezones (
...
CREATE INDEX idx_core_timezones_name ON core_timezones(name);
CREATE INDEX idx_core_timezones_is_active ON core_timezones(is_active);

-- Insert common timezones
INSERT INTO core_timezones (name, abbreviation, utc_offset, utc_dst_offset, description) VALUES
...
-- Add comment
COMMENT ON TABLE core_timezones IS 'Reference data for timezones (IANA timezone database)';
