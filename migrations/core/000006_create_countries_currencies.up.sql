...
INSERT INTO countries (name, code, iso2, iso3, region) VALUES
    -- North America
...
-- Comment on tables
COMMENT ON TABLE countries IS 'Countries reference data';
COMMENT ON COLUMN countries.code IS 'Country calling code (phone prefix, e.g., +1, +44, +7)';
COMMENT ON COLUMN countries.iso2 IS 'ISO 3166-1 alpha-2 code (2 letters)';
COMMENT ON COLUMN countries.iso3 IS 'ISO 3166-1 alpha-3 code (3 letters)';
COMMENT ON TABLE currencies IS 'Currencies reference data';
COMMENT ON TABLE country_currencies IS 'Many-to-many relationship between countries and their currencies';
