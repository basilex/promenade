...
🇬🇧 [English](MODULE_CONFIG_ARCHITECTURE.es.md) | [🇺🇦 Українська](../uk/MODULE_CONFIG_ARCHITECTURE.uk.md) | [🇩🇪 Deutsch](../de/MODULE_CONFIG_ARCHITECTURE.de.md) | [🇵🇹 Português](../pt/MODULE_CONFIG_ARCHITECTURE.pt.md) | 🇪🇸 **Español**
