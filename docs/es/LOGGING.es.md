[🇬🇧 English](../LOGGING.md) | [🇺🇦 Українська](../uk/LOGGING.uk.md) | [🇩🇪 Deutsch](../de/LOGGING.de.md) | [🇵🇹 Português](../pt/LOGGING.pt.md) | 🇪🇸 **Español**

# Guía de Logging Estructurado

## Descripción General

Promenade usa **slog** (structured logging de Go 1.21+) para logging de alto rendimiento y legible por máquina.

## Beneficios Clave

[+] **Logging estructurado** - Formato JSON para automatización
[+] **Campos de contexto** - request_id, user_id, trace_id
[+] **Niveles de log** - Debug, Info, Warn, Error
[+] **Rendimiento** - Zero allocation donde sea posible
...
Registra automáticamente todas las solicitudes HTTP con campos estructurados:
...
Registra panics con stack trace completo:
...
logger.Info("User authenticated",
    slog.String("password", password), // [X] ¡NUNCA!
)

// DON'T log in loops unnecessarily
for _, item := range items {
    logger.Debug("Processing item") // [X] Puede crear millones de logs
}
```

## Integración con Sistemas de Monitoreo

Formato JSON es fácilmente analizado por sistemas:
...
slog está optimizado para rendimiento:

- Zero allocation para tipos básicos
- Evaluación perezosa de atributos
